...
{
       0,    76,    76,    81,    82,    87,    88,    89,    90,    95,
     108,   112,   115,   122,   127,   128,   129,   130,   138,   139,
     140,   141,   142,   143,   144,   145,   146,   147,   161
};
#endif
...
#line 95 "interpreter.y"
        ...
        if (idx == -1) {
            idx = add_symbol((yyvsp[-3].strval));  // Add new variable if not found
        }
        symbol_table[idx].value = (yyvsp[-1].int_val);  // Assign value
...
#line 108 "interpreter.y"
                                   {
        printf("%s", (yyvsp[-1].strval));  // Print string
...
#line 112 "interpreter.y"
                           {
        printf("%d", (yyvsp[-1].int_val));  // Print evaluated expression
    }
#line 1307 "y.tab.c"
    break;
...
#line 130 "interpreter.y"
        ...
        if ((yyvsp[0].int_val) == 0) {
            ...
            (yyval.int_val) = (yyvsp[-2].int_val) / (yyvsp[0].int_val);  // Division
        }
    }
#line 1346 "y.tab.c"
    break;
...
#line 147 "interpreter.y"
        ...
        if (idx == -1 || !symbol_table[idx].initialized) {
            ...
            (yyval.int_val) = symbol_table[idx].value;  // Retrieve variable value
        }
