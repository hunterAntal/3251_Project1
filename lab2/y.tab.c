...
static const char *const yytname[] =
{
  ...
  "ELSE", "ENDIF", "PRINT", "NEWLINE", "$accept", "program", "if", "then",
  "else", "endif", "print", "newline", "bye", YY_NULLPTR
};
